...
class OutputArgParse {
  ...
  public:
    ...
    TCLAP::SwitchArg output_tsv{
        "", "output_tsv", "Output also as a tsv file (per generation)", cmd, false};
    TCLAP::SwitchArg output_summary{
        "", "output_summary", "Output a summary of the simulation", cmd, false};
