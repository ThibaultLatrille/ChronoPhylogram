...
class Tree {
  public:
    ...
    void add_to_trace(Trace& trace) const {
        trace.add("Number_nodes", nb_nodes());
        trace.add("Number_branches", nb_branches());
        trace.add("Number_leaves", nb_leaves());
        trace.add("Total_length", total_length());
        trace.add("Min_distance", min_distance_to_root());
        trace.add("Max_distance", max_distance_to_root());
        trace.add("Root_age", max_distance_to_root());
        trace.add("Ultrametric", is_ultrametric());
    }
