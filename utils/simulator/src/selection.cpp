...
// Set the static variable nbr_changes from the OrnsteinUhlenbeckBiasModel class to 0.
int OrnsteinUhlenbeckBiasModel::nbr_changes = 0;
...
int main(int argc, char *argv[]) {
    ...
    Trace trace(args.output_tsv.getValue());
    ...
    Trace params(args.output_summary.getValue());
    tree.add_to_trace(params);
    params.add("Number_optimum_changes", OrnsteinUhlenbeckBiasModel::nbr_changes);
    params.write_tsv(args.output_path.getValue() + ".params");
